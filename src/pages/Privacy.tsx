    ...
    <div className="min-h-screen bg-background text-foreground px-6 py-20">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose max-w-none space-y-6 text-muted-foreground leading-relaxed">
          ...
          <p>When you use our services, we collect the information you provide through our forms, including your name, email address, company name, project details, and budget preferences. We also collect payment information processed securely through Stripe.</p>

          <h2 className="font-serif text-xl text-foreground">How We Use Your Information</h2>
          <p>We use your information to deliver our design and development services, process payments, communicate with you about your project, and improve our services. We do not sell your personal data to third parties.</p>
          ...
          <p>We use Stripe for payment processing and managed cloud providers for hosting. These services have their own privacy policies governing their use of your data.</p>
